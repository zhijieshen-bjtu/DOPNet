...
from networkv7.DBAT import *

from networkv7.equisamplingpoint import genSamplingPattern
...
class LeWinTransformerBlock(nn.Module):
    def __init__(self, dim, input_resolution, num_heads, win_size=8, shift_size=4,
        ...
        self.dattn = DeformableHeadAttention(num_heads, dim, k=9, last_feat_height=self.input_resolution[0], last_feat_width=self.input_resolution[1], scales=1, dropout=0, need_attn=False)
