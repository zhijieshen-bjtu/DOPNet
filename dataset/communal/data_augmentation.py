...
if __name__ == '__main__':
    ...
    np.random.seed(123)
    pano_img_path = "/data/cylin/zzs/Datasets/mp3d/image/TbHJrupSAjP_f320ae084f3a447da3e8ab11dd5f9320.png"
    label_path = "/data/cylin/zzs/Datasets/mp3d/label/TbHJrupSAjP_f320ae084f3a447da3e8ab11dd5f9320.json"
    ...
    draw_floorplan(uv2xyz(corners, plan_y=1.6)[..., ::2], show=True, marker_color=0.5, center_color=0.8, show_radius=8)
...
if __name__ == '__main__1':
    ...
    from visualization.floorplan import draw_floorplan
    from utils.conversion import uv2xyz, xyz2depth
...
if __name__ == '__main__2':
    ...
    # np.random.seed(1234)
    pano_img_path = "/data/cylin/zzs/Datasets/mp3d/image/VVfe2KiqLaN_35b41dcbfcf84f96878f6ca28c70e5af.png"
    label_path = "/data/cylin/zzs/Datasets/mp3d/label/VVfe2KiqLaN_35b41dcbfcf84f96878f6ca28c70e5af.json"
    pano_img = read_image(pano_img_path)
    label = read_label(label_path)
    ...
    for i in range(5):
        ...
        new_image = pano_stretch_image(pano_img.copy(), kx, ky, kz)
        plt.axis('off')
