...
if __name__ == '__main__':
    ...
    for i in range(1):
        for mode in modes:
            print(mode)
            mp3d_dataset = PanoS2D3DDataset(root_dir='/data/cylin/zzs/Datasets/pano_s2d3d', mode=mode, aug={
                # 'STRETCH': True,
                # 'ROTATE': True,
                # 'FLIP': True,
                # 'GAMMA': True
            ...
            # continue
            save_dir = f'/data/cylin/zzs/Datasets/pano_s2d3d/visualization/{mode}'
            ...
            for data in bar:
                ...
                # pano_img = draw_boundaries(data['image'].transpose(1, 2, 0), corners_list=[data['corners']], show=True, length=1024, ratio=data['ratio'])
